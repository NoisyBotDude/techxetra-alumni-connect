...
const newsItems = [
  {
    ...
    description:
      "Join our AI workshop to enhance your skills. Limited slots available!",
    type: "event",
    date: "March 20, 2024",
    size: "large"
  },
  {
    ...
    description:
      "Our students won the regional coding competition! Congratulations to all winners.",
    type: "achievement",
    date: "March 15, 2024",
    size: "small"
  },
  ...
  },
  {
    ...
    description:
      "We are excited to announce new courses on AI and Blockchain starting this summer.",
    type: "announcement",
    date: "March 5, 2024",
    size: "large"
  },
  {
    ...
    description:
      "Applications are now open for our exchange program with top universities worldwide.",
    type: "event",
    date: "March 2, 2024",
    size: "small"
  }
...
const NewsFeed = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <Typography
        variant="h4"
        className="text-center text-#EC4899-600 font-extrabold mb-8"
      >
        News and Updates
      </Typography>
